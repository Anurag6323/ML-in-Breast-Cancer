...
sample1 <- read.csv(here("D:/Academics/IITM/BT/BT3041/Project", "GSM3040918_BLOOD_36581.readCounts.txt"), sep = ' ', header = FALSE)
colnames(sample1) <- c("EntrezID", "Sample1")

sample2 <- read.csv(here("D:/Academics/IITM/BT/BT3041/Project", "GSM3040919_BLOOD_36683.readCounts.txt"), sep = ' ', header = FALSE)
colnames(sample2) <- c("EntrezID", "Sample2")

sample3 <- read.csv(here("D:/Academics/IITM/BT/BT3041/Project", "GSM3040920_BLOOD_36828.readCounts.txt"), sep = ' ', header = FALSE)
colnames(sample3) <- c("EntrezID", "Sample3")

sample4 <- read.csv(here("D:/Academics/IITM/BT/BT3041/Project", "GSM3040921_BLOOD_47934.readCounts.txt"), sep = ' ', header = FALSE)
colnames(sample4) <- c("EntrezID", "Sample4")

sample5 <- read.csv(here("D:/Academics/IITM/BT/BT3041/Project", "GSM3040922_BLOOD_58029.readCounts.txt"), sep = ' ', header = FALSE)
colnames(sample5) <- c("EntrezID", "Sample5")

sample6 <- read.csv(here("D:/Academics/IITM/BT/BT3041/Project", "GSM3040923_BLOOD_68172.readCounts.txt"), sep = ' ', header = FALSE)
colnames(sample6) <- c("EntrezID", "Sample6")

sample7 <- read.csv(here("D:/Academics/IITM/BT/BT3041/Project", "GSM3040940_TUMOR_31176.readCounts.txt"), sep = ' ', header = FALSE)
colnames(sample7) <- c("EntrezID", "Sample7")

sample8 <- read.csv(here("D:/Academics/IITM/BT/BT3041/Project", "GSM3040941_TUMOR_36285.readCounts.txt"), sep = ' ', header = FALSE)
colnames(sample8) <- c("EntrezID", "Sample8")

sample9 <- read.csv(here("D:/Academics/IITM/BT/BT3041/Project", "GSM3040945_TUMOR_36828.readCounts.txt"), sep = ' ', header = FALSE)
colnames(sample9) <- c("EntrezID", "Sample9")

sample10 <- read.csv(here("D:/Academics/IITM/BT/BT3041/Project", "GSM3040946_TUMOR_37232.readCounts.txt"), sep = ' ', header = FALSE)
colnames(sample10) <- c("EntrezID", "Sample10")

sample11 <- read.csv(here("D:/Academics/IITM/BT/BT3041/Project", "GSM3040947_TUMOR_37289.readCounts.txt"), sep = ' ', header = FALSE)
colnames(sample11) <- c("EntrezID", "Sample11")

sample12 <- read.csv(here("D:/Academics/IITM/BT/BT3041/Project", "GSM3040948_TUMOR_47934.readCounts.txt"), sep = ' ', header = FALSE)
colnames(sample12) <- c("EntrezID", "Sample12")

sample13 <- read.csv(here("D:/Academics/IITM/BT/BT3041/Project", "GSM3040949_TUMOR_68052.readCounts.txt"), sep = ' ', header = FALSE)
colnames(sample13) <- c("EntrezID", "Sample13")

sample14 <- read.csv(here("D:/Academics/IITM/BT/BT3041/Project", "GSM3040950_TUMOR_78322.readCounts.txt"), sep = ' ', header = FALSE)
